...
app.secret_key = "L9IRCH_HOST_STABLE_SECRET_2026_XK9"
...
# ============== بيانات المسؤول ==============
ADMIN_USERNAME = "7826514908"
ADMIN_PASSWORD_RAW = "7826514908"

# ============== إعدادات البوت والإشعارات ==============
BOT_TOKEN = "8652231997:AAFHkbhvc1CneBfVpfuWhsFplLBCEC66zEY"
ADMIN_TELEGRAM_ID = 7826514908
ADMIN_TELEGRAM_USERNAME = "@l9irch_13x1"
...
def api_register():
    ...
    threading.Thread(
        target=notify_admin,
        args=(
            f"🔔 *مستخدم جديد اشترك في L9IRCH HOST!*\n"
            f"👤 المستخدم: `{username}`\n"
